...
@section('script')
    <script src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js"
            ...
            crossorigin=""></script>
    <script>
        var mymap = L.map('map').setView([{{ $settings->latitude }},{{ $settings->longitude }}], 13);
        ...
        var marker = L.marker([{{ $settings->latitude }},{{ $settings->longitude }}]).addTo(mymap);
        marker.bindPopup("<b>Yow Yow!</b><br>I am Mohammd.").openPopup();
    </script>
@endsection
@section('content')
                    ...
                    <div class="contact-info-area">
                        ...
                        <div class="contact-info-wrap">
                            ...
                            <div class="single-contact-info">
                                ...
                                <div class="contact-info-content">
                                    <p style="direction: ltr;"> {{ $settings->telephone }} / {{ $settings->telephone2 }} </p>
                                </div>
                            </div>
                        </div>
                    </div>
