                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                                <div class="slider-single-img slider-animated-1">
                                    ...
                                    <img class="animated" src="{{ asset(env('BANNER_IMAGE_UPLOAD_PATH') . $slider->image) }}" alt="{{ $slider->image }}" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @foreach($indexTopBanners->chunk(3)->first() as $banner)
                    <div class="col-lg-4 col-md-4">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="#"><img class="animated" src="{{ asset(env('BANNER_IMAGE_UPLOAD_PATH') . $banner->image) }}" alt="{{ $banner->image }}" /></a>
                                                    ...
                                                    @auth
                                                       @if($product->checkUserWishlist(auth()->id()))
                                                            <a href="{{ route('home.wishlist.remove' , ['product' => $product->id]) }}">
                                                                ...
                                                                <span class="ht-product-action-tooltip">به لیست علاقه مندیها اضافه شده است </span>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 text-right">
                    <div class="single-banner mb-30 scroll-zoom">
                        <a href="{{ $banner->button_link }}"><img src="{{ asset(env('BANNER_IMAGE_UPLOAD_PATH') . $banner->image) }}" alt="{{ $banner->image }}" /></a>
