            ...
            <form action="{{route('admin.coupons.store')}}" method="post">
               ...
               <div class="form-row">
                   ...
                   <div class="form-group col-md-3">
                       ...
                       <input type="text" name="percentage" id="percentage" value="{{old('percentage')}}" class="form-control">
                   </div>
                   <div class="form-group col-md-3">
                       <label for="max_percentage_amount">حداکثر مبلغ برای نوع درصدی</label>
                       <input type="text" name="max_percentage_amount" id="max_percentage_amount" value="{{old('max_amount')}}" class="form-control">
                   </div>
                   <div class="form-group col-md-3">
